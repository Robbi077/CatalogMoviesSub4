package com.example.catalogmoviessub2.Provide;
...
import static com.example.catalogmoviessub2.Helper.DatabaseContract.AUTHORITY;
...
public class MovieProvider extends ContentProvider {
    ...
    private FvHelper noteHelper;

    @Override
    public boolean onCreate() {
        noteHelper = new FvHelper(getContext());
        noteHelper.Open();
        return true;
    }
