...
public class UpComingFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<MoviesItem>> {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.RcUp_Coming);
        recyclerView.setLayoutManager(new LinearLayoutManager(view.getContext()));
        String endpoint = BuildConfig.Base_Url + "movie/upcoming?api_key=" +
                BuildConfig.Api_Key + "&language=" + Locale.getDefault().toString()
                .replaceAll("_", "_");
        //new MyAsyncTask(getContext(), recyclerView, endpoint).execute();
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        Log.d("dataUpCom", String.valueOf(moviesAdapter.getListMovies()));
